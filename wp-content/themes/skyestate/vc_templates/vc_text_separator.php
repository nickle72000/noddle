...
<div class="<?php echo esc_attr(trim($css_class)); ?>">
	<div class="vc_sep_holder vc_sep_holder_l"><div<?php echo $inline_css; ?> class="vc_sep_line"></div></div>
	<?php if($title!=''): ?><h4><?php echo $title; ?></h4><?php endif; ?>
	<div class="vc_sep_holder vc_sep_holder_r"><div<?php echo $inline_css; ?> class="vc_sep_line"></div></div>
</div>
